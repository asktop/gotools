...
//
//   fInfo, _ := file.Stat()
//   _, err = c.GetClient().PutObject(c.GetBucket(), filePathName, file, fInfo.Size(), minio.PutObjectOptions{ContentType: afile.GetContentType(fInfo.Name())})
//   if err != nil {
//       return url, err
//   }
...
//   }
//   defer file.Close()
//   _, err = c.GetClient().PutObject(c.GetBucket(), filePathName, file, header.Size, minio.PutObjectOptions{ContentType: afile.GetContentType(header.Filename)})
//   if err != nil {
//       return url, err
//   }
//   url = c.GetAllUrl(filePathName)
