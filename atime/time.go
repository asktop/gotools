...
func FormatUnixNanoTimestamp(format string, timestamp interface{}) string {
    ...
    if err != nil {
        if err.Error() != "" {
            fmt.Println("github.com/asktop/gotools/atime ParseUnixNanoTimestamp", "timestamp:", timestamp, "err:", err)
        }
        return ""
    }
...
func FormatMilliTimestamp(format string, timestamp interface{}) string {
    ...
    if err != nil {
        if err.Error() != "" {
            fmt.Println("github.com/asktop/gotools/atime ParseMilliTimestamp", "timestamp:", timestamp, "err:", err)
        }
        return ""
    }
    return fn.Format(format)
...
func UnFormatUnixNanoTimestamp(format string, timeStr string) int64 {
    ...
    if err != nil {
        fmt.Println("github.com/asktop/gotools/atime UnFormatUnixNanoTimestamp", "format:", format, "timeStr:", timeStr, "err:", err)
        return 0
    }
    return t.UnixNano()
}
...
func UnFormatMilliTimestamp(format string, timeStr string) int64 {
    t, err := time.ParseInLocation(format, timeStr, time.Local)
    if err != nil {
        fmt.Println("github.com/asktop/gotools/atime UnFormatMilliTimestamp", "format:", format, "timeStr:", timeStr, "err:", err)
        return 0
    }
...
func UnFormatTimestamp(format string, timeStr string) int64 {
    t, err := time.ParseInLocation(format, timeStr, time.Local)
    if err != nil {
        fmt.Println("github.com/asktop/gotools/atime UnFormatTimestamp", "format:", format, "timeStr:", timeStr, "err:", err)
        return 0
    }
    return t.Unix()
}
...
func UnFormatTime(timeStr string) int64 {
    return UnFormatTimestamp(TIME, timeStr)
}
